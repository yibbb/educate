...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        ...
        <form method="post" class="layui-form" >
            ...
            <hr class="hr15" >
            <input value=还没有培训学员账号？点击立即注册 lay-submit lay-filter="register" style="width:100%;" type="submit">
        ...
        $(function  () {
            layui.use('form', function(){
                  ...
                  $.ajax({
                      ...
                      success: function (msg) {
                          if (msg === 'ok') {
                              ...
                              // });
                              // setTimeout(function () {
                                  location.href = '/student/student_index'
                              // }, 1200);
                          } else {
                              layui.layer.msg(msg, {
                                  icon: 2,
              ...
              form.on('submit(register)', function(){
                    // alert(888)
                    location.href='student-register.jsp'
                    return false;
                });
            });
